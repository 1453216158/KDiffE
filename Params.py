...
def ParseArgs():
	...
	parser.add_argument('--similarity', type=str, default='80_10', help='Attention-aware Matrix')
	parser.add_argument('--M', type=int, default=50, help='Number of steps in each random walk')
	parser.add_argument('--R', type=int, default=8, help='Number of random walks')
	parser.add_argument('--epsilon', type=float, default=0.5, help='Value of epsilon for controlling S contribution')
	parser.add_argument('--data', type=str, default='sports')
